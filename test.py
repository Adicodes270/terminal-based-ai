                    ...
                    with processing_lock:
                        ...
                        if transcribed_text and len(transcribed_text.split()) > 1:
                            threading.Thread(
                                ...
                                args=(transcribed_text, is_voice_mode),
                                daemon=True
                            ).start()
...
while exit_ai == 0:
    ...
    print("\n--- AI Menu ---\n1: Exit AI  2: Enable Voice Mode  3: Disable Voice Mode 4: Enable Voice Recognition")
    print("5: Disable Voice Recognition 6:Clear Terminal Mode(Clears Terminal after every prompt) 7:Clear Terminal Mode Off")
